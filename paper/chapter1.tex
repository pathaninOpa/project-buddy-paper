...
\section{Scope}
\begin{enumerate}
	\item Integrating GEMMA 3 (Large Language Model) for more natural and engaging dialogues with the elderly.
	\item Establishing an interactive system using a Raspberry Pi 5 (2GB RAM) for data retrieval and feedback 
	\item Building an intercommunication system using WebRTC.
	\item Analyzing elder's mood progress report , however does not diagnose elders mental health 
\end{enumerate}
...
\begin{table}[!ht]
	...
	\begin{tabular}{|p{2.15cm}|c|c|c|c|c|c|c|c|c|}
		...
		& & & & & & & & 
		\\ project proposal & \cellcolor[HTML]{000000} 
		& & & & & & & & \\ \hline
		
		2: Gather em- & & \cellcolor[HTML]{000000} 
		& & & & & & & 
		\\bedded material & & \cellcolor[HTML]{000000}
		& & & & & & &   \\ \hline
		
		3: Assemble and & & & \cellcolor[HTML]{000000} 
		& \cellcolor[HTML]{000000} & & & & & 
		\\program the em- & & & \cellcolor[HTML]{000000} 
		& \cellcolor[HTML]{000000} & & & & & 
		\\bbedded & & & \cellcolor[HTML]{000000} 
		& \cellcolor[HTML]{000000} & & & & & \\ \hline
		
		4: Design the  & & & & & \cellcolor[HTML]{000000} 
		& & & & 
		\\application & & & & & \cellcolor[HTML]{000000} 
		& & & & \\ \hline
		
		5: Testing & & & & & & \cellcolor[HTML]{000000} 
		& \cellcolor[HTML]{000000} 
		& \cellcolor[HTML]{000000} 
		&  \\ \hline
