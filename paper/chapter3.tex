...
\begin{itemize}
	...
	\item Simple rule-based or ML-based scoring:
	\begin{itemize}
		\item Moving average
		\item Emotion variability score
		\item Daily anomaly detection
	\end{itemize}
	\item Optional NLP pipeline for message sentiment
\end{itemize}

\subsubsection{Evaluation}
\begin{itemize}
	\item Compare predicted trends vs. actual logs
	\item Graph visualization using Matplotlib/Seaborn or FL Chart in-app
	\item Signal detection accuracy:
	\begin{itemize}
		\item Stable mood
		\item Negative trend
		\item Sudden spikes
...
\subsubsection{Integration with App}
\begin{itemize}
	\item Export results back to Firebase
	\item Visualize on caregiver analytics screen
	\item Trigger notifications for:
	\begin{itemize}
		\item Unusual negative patterns
		\item Sudden emotion drops
		\item Extended sadness/anxiety period
	\end{itemize}
\end{itemize}
